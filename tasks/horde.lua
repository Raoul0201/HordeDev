...
local pylons = {
    ...
    "MeteoricHellborne",       -- Hellfire spawns Hellborne
    ...
    "DeadlySpires",            -- Soulspires Drain Health, Soulspires grant +1 Aether
    ...
    "UnstableFiends",          -- Elite Damage +25%, Aether Fiends explode and damage FOE
